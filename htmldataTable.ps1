...
function CreateHtmlTableFromDataAsString($data)
{
...
"@
    ...
    $htmlData = $data | ConvertTo-Html -Head $htmlHead -PreContent $preContent | Out-String
...
$data = Get-Process
$htmlTable = CreateHtmlTableFromDataAsString($data)
$htmlTable | Out-File C:\tmp.html
